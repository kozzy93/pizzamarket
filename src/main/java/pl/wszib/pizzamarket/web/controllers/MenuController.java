...
public class MenuController {
    ...
    public String processPizzaOrder(@PathVariable Long pizzaId, @ModelAttribute("orderAddress") @Valid OrderAddressModel orderAddress, BindingResult bindingResult, Model model){
